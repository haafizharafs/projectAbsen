    ...
    <div class="d-flex" id="wrapper">
     ...
     <div id="page-content-wrapper">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="container-fluid px-4">
                    <div class="profile-container1 text-center">
                        <img src="images/profil rida.jpg" alt="Foto Profil">
                        <h3>Nama Pengguna</h3>
                        ...
                        <a href="editprofil.html" ><Button id="editButton">Edit Profile</Button></a>
