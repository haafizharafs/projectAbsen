    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-side" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="dosen.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-home me-3"></i>Dashboard</a>
                <a href="verifikasi.html" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                            ...
                            <i class="fas fa-user me-2"></i>&nbsp &nbsp &nbsp &nbsp Dosen
                        </a>
